  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex flex-col gap-2">
        {/* Baris 1: Saldo Kas */}
        <div className="bg-surface-card/60 border border-white/5 rounded-2xl p-3.5 flex items-center justify-between gap-3">
        ...
        <div className="grid grid-cols-2 gap-2">
          <div className="bg-surface-card/60 border border-white/5 rounded-2xl p-2.5 flex flex-col justify-between">
            <span className="text-[9px] font-bold text-brand-500 uppercase">In (Bulan ini)</span>
            <span className="text-[13px] font-bold text-brand-500 leading-tight mt-1 truncate">
      ...
      <div className="flex justify-between items-center px-1">
        <h2 className="text-[13px] font-bold text-slate-300">Rekap Buku Kas Utama</h2>
        {isBendahara && (
          <button
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-3">
              <div className="grid grid-cols-2 gap-2">
                ...
                {jenis === 'Pemasukan' ? (
                  <div className="space-y-1">
                    <Label className="text-slate-400 text-[10px] uppercase font-bold">Sumber Dana</Label>
                    <select
                      className="flex h-9 w-full rounded-xl border border-white/5 bg-slate-900/80 text-xs text-white px-2.5 focus:outline-none focus:ring-1 focus:ring-brand-500"
                      value={sumberDana}
                  ...
                  <div className="space-y-1">
                    <Label className="text-slate-400 text-[10px] uppercase font-bold">Kategori</Label>
                    <Input
              ...
              <div className="space-y-1">
                <Label className="text-slate-400 text-[10px] uppercase font-bold">Keterangan / Deskripsi</Label>
                <Input
            ...
            <div className="flex gap-2 mt-2">
              ...
              <Button
                type="submit"
                disabled={submitting}
                className={`${editingId ? 'flex-1' : 'w-full'} bg-brand-500 hover:bg-brand-400 text-text-inverse font-extrabold text-xs h-9 rounded-xl transition-all shadow-md`}
              >
      ...
      <Card className="bg-surface-card/40 border-white/5 rounded-2xl p-4 overflow-hidden">
        <div className="flex justify-between items-center mb-4 border-b border-white/5 pb-2">
          <span className="text-[11px] font-bold text-slate-300">Catatan Aliran Kas</span>
          <span className="text-[9px] font-semibold text-slate-500">Urut Terkini</span>
        </div>
        ...
        <div className="space-y-3 mb-4">
          <div className="flex gap-2">
            <div className="relative flex-1">
              ...
              <Input
                ...
                className="pl-9 pr-8 bg-surface-card/60 border-white/5 text-xs text-white h-10 rounded-xl w-full focus-visible:ring-brand-500"
              />
              {searchTerm && (
                <button
          ...
          {showAdvancedFilters && (
            <div className="p-3 bg-surface-card/80 border border-brand-500/10 rounded-xl space-y-3 animate-in fade-in slide-in-from-top-2 duration-200">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-4 gap-2">
                  ...
                  <div className="flex items-center gap-1.5">
                    <div className="relative flex-1">
                      <Input
                        ...
                        className="px-2 bg-slate-950/80 border-white/5 text-[11px] text-slate-300 h-8 rounded-lg w-full focus-visible:ring-brand-500 [color-scheme:dark]"
                      />
                    </div>
                ...
                <div className="space-y-1">
                  <Label className="text-[9px] font-bold text-slate-400 uppercase tracking-wider block">Sumber Dana</Label>
                  <select
                    className="flex h-8 w-full rounded-lg border border-white/5 bg-slate-950/80 text-[11px] text-slate-300 px-2 focus:outline-none focus:ring-1 focus:ring-brand-500"
                ...
                <div className="space-y-1">
                  <Label className="text-[9px] font-bold text-slate-400 uppercase tracking-wider block">Kategori</Label>
                  <select
                    className="flex h-8 w-full rounded-lg border border-white/5 bg-slate-950/80 text-[11px] text-slate-300 px-2 focus:outline-none focus:ring-1 focus:ring-brand-500"
          ...
          {isAnyFilterActive && (
            <div className="flex flex-wrap items-center gap-1.5 pt-1">
              ...
              {searchTerm && (
                <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[10px] font-medium bg-brand-500/10 border border-brand-500/20 text-brand-500">
            ...
            return (
              ...
              >
                ...
                <div className="col-start-2 col-end-3 row-start-3 row-end-4">
                  <span className={`text-[12px] font-bold block ${isPemasukan ? 'text-brand-500' : 'text-slate-100'}`}>
